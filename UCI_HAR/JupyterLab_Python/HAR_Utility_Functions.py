...
#import os
#import sys
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 sas-dlpy
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 siml
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 xgboost
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 seaborn
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 pywavelets
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 tensorflow-gpu
#!{sys.executable} -m pip --default-timeout=100 install --user --proxy=http://proxy:3128 keras
...
#import os 
#import sys 
#env=os.path.expanduser(os.path.expandvars("/home/william.nadolski@sas.com/.local/lib/python3.6/site-packages/xgboost"))
#sys.path.append(env)
#import xgboost 
...
#print(sys.path)
#/home/william.nadolski@sas.com/.local/lib/python3.6/site-packages

#=========

#print(os.listdir("/home/william.nadolski@sas.com/.local/lib/python3.6/site-packages/xgboost"))

#=========

#!{sys.executable} -m pip --default-timeout=100 uninstall xgboost --y
...
def get_first_n_peaks(x,y,top_n_peaks):
    x_, y_ = list(x), list(y)
...
def get_xy_coords(x_values, y_values, mph):
    ...
    peaks_x, peaks_y = get_first_n_peaks(x_values[indices_peaks], y_values[indices_peaks],top_n_peaks)
...
folder_ucihar = 'shared/data/UCI HAR Dataset/' 
